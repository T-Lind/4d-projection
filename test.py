...
plane_angle = 0.65
plane_points = [
    (plane_x + plane_size * math.cos(plane_angle), 0.0, plane_y + plane_size * math.sin(plane_angle)),
    (plane_x - plane_size * math.cos(plane_angle), 0.0, plane_y - plane_size * math.sin(plane_angle)),
    (plane_x - plane_size * math.cos(plane_angle), 1.0, plane_y - plane_size * math.sin(plane_angle)),
    (plane_x + plane_size * math.cos(plane_angle), 1.0, plane_y + plane_size * math.sin(plane_angle)),
]
...
def draw():
    ...
    for edge in shape_edges:
        for vertex in edge:
            glVertex3fv(shape_points[vertex])
    glEnd()
