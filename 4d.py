...
from v2.helper import calculate_intersection, convert_to_3d_coordinates
...
def compute_shapes():
    ...
    for intersections in shape_intersections_total:
        ...
        for intersection in intersections:
            converted_coords.append(convert_to_3d_coordinates(intersection, hplane_point, hplane_angle))
